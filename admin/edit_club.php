        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">EDIT Club</h3> </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal row" method="POST"  name="userform" enctype="multipart/form-data" action="../app/crud_editclub.php?id=<?php echo $_GET['id'];?>" id="form1" name="form1">
