                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="row" method="POST"  name="userform" enctype="multipart/form-data" action="submit_payments.php" id="form1" name="form1">
                                    <div class="form-group col-md-6">
                                       ...
                                       <div class="form-group col-md-6">
                                                <label class="control-label">SELECT NEW PLAN</label>
